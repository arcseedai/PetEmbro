      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-2xl mx-auto mb-12">
          ...
          <p class="mt-3 text-stone-600 text-sm sm:text-base leading-relaxed">
            Have questions about an upcoming gift, memorial keepsake, or custom sizing? Send a message and our artisan will get back to you within 24 hours.
          </p>
        </div>
            ...
            <div class="bg-linen-100 rounded-3xl p-6 sm:p-8 shadow-md border stitch-border-dashed space-y-6">
              ...
              <div class="space-y-4 text-sm text-stone-700">
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@petembro.com" class="text-terracotta hover:underline">hello@petembro.com</a>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" class="text-emerald-700 hover:underline">+1 (555) 382-7638</a>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-stone-600">Mon – Fri: 9:00 AM – 6:00 PM (EST)</p>
                    <p class="text-xs text-stone-600">Weekend stitching sessions by appointment</p>
                  </div>
                </div>
              </div>
              ...
              <div class="pt-4 border-t border-linen-300">
                ...
                <div class="flex items-center gap-2">
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-200 hover:bg-terracotta hover:text-white flex items-center justify-center text-stone-700 transition" title="Instagram">
                  ...
                  <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-200 hover:bg-stone-900 hover:text-white flex items-center justify-center text-stone-700 transition" title="TikTok">
                  ...
                  <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-200 hover:bg-red-700 hover:text-white flex items-center justify-center text-stone-700 transition" title="Pinterest">
                  ...
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-200 hover:bg-blue-600 hover:text-white flex items-center justify-center text-stone-700 transition" title="Facebook">
