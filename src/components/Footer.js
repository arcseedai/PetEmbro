      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-3">
            ...
            <span class="font-serif text-2xl font-bold text-wood-dark tracking-tight">PetEmbro</span>
          </div>
          <p class="text-stone-600 text-sm leading-relaxed">
            Preserving the spirit, eyes, and warmth of your beloved companion through miniature single-strand cotton embroidery hoops and keychains.
          </p>
          ...
          <div class="space-y-2.5 text-sm text-stone-600">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:orders@petembro.com" class="hover:text-terracotta transition">orders@petembro.com</a>
              </div>
            </div>
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" class="hover:text-emerald-700 transition">+1 (555) 382-7638</a>
              </div>
            </div>
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-stone-500">Handmade & shipped worldwide with tracked delivery.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center gap-2.5">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-100 hover:bg-terracotta hover:text-white flex items-center justify-center text-stone-700 transition shadow-sm hover:shadow active:scale-95" title="Instagram">
            ...
            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-100 hover:bg-stone-900 hover:text-white flex items-center justify-center text-stone-700 transition shadow-sm hover:shadow active:scale-95" title="TikTok">
            ...
            <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-100 hover:bg-red-700 hover:text-white flex items-center justify-center text-stone-700 transition shadow-sm hover:shadow active:scale-95" title="Pinterest">
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-linen-100 hover:bg-blue-600 hover:text-white flex items-center justify-center text-stone-700 transition shadow-sm hover:shadow active:scale-95" title="Facebook">
